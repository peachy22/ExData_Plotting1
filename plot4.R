...
plot(data$datetime,data$global_active_pwr,type='l',ylab="Global Active Power (kilowatts)",xlab="")
...
plot(data$datetime,data$global_reactive_pwr,type='l',ylab="Globval Reactive Power",xlab="datetime")
